 ...
 class ES3 extends CApplicationComponent
{
   ...
   //         ->setOption('Metadata', array('Foo' => 'Bar'))
    ...
    /**
     * Function that generates embed code for videos hosted at AWS S3 using CloudFrontService
     * @author Everton Mendonça
     * @param type $fileName
     * @param type $fileExtension
     */
    public function generateEmbedCodeRMTPAWSS3($fileName, $fileExtension, $webUrl, $rmtpUrl) {
        $stringPlayerCss = "<link rel='stylesheet' type='text/css' \n"
                . "\t href='".$webUrl."video-js/video-js.min.css' />\n";
        $stringPlayerJs = "<script type='text/javascript' \n"
                . "\t src='".$webUrl."video-js/video.js'></script>\n";
